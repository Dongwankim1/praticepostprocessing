...
class App{
    constructor(){
        ...
        window.addEventListener('reisze',this.resize.bind(this),false);
        this.resize();
    ...
    onClick(e){
        ...
        this.ctx.drawImage(
            this.image,
            0,0,
            this.image.width,this.image.height,this.imgPos.x,this.imgPos.y,this.imgPos.width,this.imgPos.height
        )
